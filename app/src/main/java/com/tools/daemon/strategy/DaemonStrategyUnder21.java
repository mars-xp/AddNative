package com.tools.daemon.strategy;
...
import com.tools.daemon.IDaemonStrategy;
import com.tools.daemon.NativeDaemonAPI20;
...
public class DaemonStrategyUnder21 implements IDaemonStrategy {
	...
	private final String BINARY_FILE_NAME		= "svboot";
