package com.test.kudaemon.strategy;
...
import com.test.kudaemon.IDaemonStrategy;
import com.test.kudaemon.nativ.NativeDaemonAPI20;
...
public class DaemonStrategyUnder21 implements IDaemonStrategy{
	...
	private final String BINARY_FILE_NAME		= "monkey";
